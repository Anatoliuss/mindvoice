...
/// Implements Therapeutic Minimalism design with Mindful Neutrals color palette.
class AppTheme {
  AppTheme._();

  // Mindful Neutrals Color Palette
  ...
  static const Color secondaryLight = Color(0xFF7B9BB0); // Muted blue-gray
  ...
  static const Color successLight = Color(0xFF6B9080); // Calming sage green
  static const Color warningLight = Color(0xFFD4A574); // Gentle amber
  static const Color errorLight = Color(0xFFC07F7F); // Muted rose
  static const Color textPrimaryLight = Color(0xFF2C3E50); // Dark blue-gray
  static const Color textSecondaryLight = Color(0xFF6C7B7F); // Medium gray
  ...
  // Dark theme colors - adapted for mental health context
  static const Color primaryDark = Color(0xFF7B9BB0);
  static const Color primaryVariantDark = Color(0xFF5A7A8F);
  static const Color secondaryDark = Color(0xFF9BB5C4);
  static const Color secondaryVariantDark = Color(0xFF7B9BB0);
  static const Color accentDark = Color(0xFFE8A87C);
  static const Color backgroundDark = Color(0xFF1A1F23);
  static const Color surfaceDark = Color(0xFF242A30);
  static const Color successDark = Color(0xFF6B9080);
  static const Color warningDark = Color(0xFFD4A574);
  static const Color errorDark = Color(0xFFC07F7F);
  static const Color textPrimaryDark = Color(0xFFE8EAED);
  static const Color textSecondaryDark = Color(0xFFBDC1C6);
  static const Color onPrimaryDark = Color(0xFF1A1F23);
  static const Color onSecondaryDark = Color(0xFF1A1F23);
  static const Color onBackgroundDark = Color(0xFFE8EAED);
  static const Color onSurfaceDark = Color(0xFFE8EAED);
  static const Color onErrorDark = Color(0xFF1A1F23);

  // Card and dialog colors
  static const Color cardLight = Color(0xFFFFFFFF);
  static const Color cardDark = Color(0xFF2A3138);
  static const Color dialogLight = Color(0xFFFFFFFF);
  static const Color dialogDark = Color(0xFF2A3138);

  // Shadow colors - subtle for therapeutic feel
  static const Color shadowLight = Color(0x08000000);
  static const Color shadowDark = Color(0x12000000);

  // Divider colors - minimal for clean interface
  static const Color dividerLight = Color(0x1A6C7B7F);
  static const Color dividerDark = Color(0x1ABDC1C6);

  // Text emphasis colors for hierarchy
  static const Color textHighEmphasisLight = Color(0xFF2C3E50);
  static const Color textMediumEmphasisLight = Color(0xFF6C7B7F);
  static const Color textDisabledLight = Color(0x616C7B7F);

  static const Color textHighEmphasisDark = Color(0xFFE8EAED);
  static const Color textMediumEmphasisDark = Color(0xFFBDC1C6);
  static const Color textDisabledDark = Color(0x61BDC1C6);
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    // Bottom navigation with therapeutic colors
    ...
    // Button themes with gentle confidence
    ...
    // Form elements with therapeutic styling
    inputDecorationTheme: InputDecorationTheme(
      ...
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12.0),
        borderSide:
            BorderSide(color: textSecondaryLight.withValues(alpha: 0.2)),
      ),
    ...
    // Interactive elements with calming colors
    ...
    // Progress indicators with success color
    progressIndicatorTheme: const ProgressIndicatorThemeData(
      color: primaryLight,
      linearTrackColor: Color(0x1A2D5A87),
    ),
  ...
  /// Dark theme optimized for mental health applications
  static ThemeData darkTheme = ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12.0),
        borderSide: BorderSide(color: textSecondaryDark.withValues(alpha: 0.2)),
      ),
      enabledBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12.0),
        borderSide: BorderSide(color: textSecondaryDark.withValues(alpha: 0.2)),
    ...
    progressIndicatorTheme: const ProgressIndicatorThemeData(
      color: primaryDark,
      linearTrackColor: Color(0x1A7B9BB0),
    ),
    sliderTheme: SliderThemeData(
